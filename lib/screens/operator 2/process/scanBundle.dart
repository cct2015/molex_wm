          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text("Bundle Qty: ${bundlQtyController.text}"),
                  SizedBox(width: 20),
                  // quantitycell(
                  //   name: "Bundle Qty",
                  //   quantity: 10,
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            PostCrimpingRejectedDetail
                              ...
                              terminalFrom:
                                  int.parse('${terminalA.terminalPart}'),
                              terminalTo:
                                  int.parse('${terminalB.terminalPart}'),
                            );
