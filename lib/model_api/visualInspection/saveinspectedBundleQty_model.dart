...
ViInspectedbudleQty viInspectedbudleQtyFromJson(String str) => ViInspectedbudleQty.fromJson(json.decode(str));

String viInspectedbudleQtyToJson(ViInspectedbudleQty data) => json.encode(data.toJson());

class ViInspectedbudleQty {
    ViInspectedbudleQty({
    ...
    factory ViInspectedbudleQty.fromJson(Map<String, dynamic> json) => ViInspectedbudleQty(
