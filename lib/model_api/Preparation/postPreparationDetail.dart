...
PostPreparationDetail postPreparationDetailFromJson(String str) => PostPreparationDetail.fromJson(json.decode(str));

String postPreparationDetailToJson(PostPreparationDetail data) => json.encode(data.toJson());
...
class PostPreparationDetail {
    ...
    factory PostPreparationDetail.fromJson(Map<String, dynamic> json) => PostPreparationDetail(
