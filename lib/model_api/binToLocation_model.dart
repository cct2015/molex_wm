...
BinToLocation binToLocationFromJson(String str) => BinToLocation.fromJson(json.decode(str));

String binToLocationToJson(BinToLocation data) => json.encode(data.toJson());
...
class BinToLocation {
    ...
    factory BinToLocation.fromJson(Map<String, dynamic> json) => BinToLocation(
